...
const MessageReceive = ({ message }: { message: iMessage }) => {
	return (
		<div className='w-max my-2'>
			<div className='bg-rose-400 hover:bg-rose-900 shadow-xl duration-1000 w-max max-w-full sm:max-w-2xl p-2 px-4 text-white rounded-3xl rounded-tl-none my-0 '>
				{message.content}
			</div>
