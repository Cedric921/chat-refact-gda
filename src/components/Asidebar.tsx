...
const Asidebar = () => {
	...
	return (
		<div className='asidebar bg-white max-h-full h-full w-full relative shadow-2xl'>
			<h2 className='md:hidden bg-gradient-to-r from-blue-300 to-slate-400 p-4 pb-2 font-extrabold text-blue-500'>
				Crypto
			</h2>
			...
			<h3 className='text-blue-500 px-4 py-1 bg-slate-300'>Contacts</h3>
