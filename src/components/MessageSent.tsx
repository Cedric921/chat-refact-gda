...
const MessageSent = ({ message }: { message: iMessage }) => {
	return (
		<div className='w-max self-end'>
			<div className='bg-blue-900 hover:bg-gray-900 shadow-xl duration-1000 w-max max-w-full sm:max-w-2xl  p-2 px-4 text-justify self-end text-white rounded-3xl rounded-br-none my-2 '>
				{message.content}
			</div>
