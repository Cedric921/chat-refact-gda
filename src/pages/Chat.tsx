	...
	return (
     ...
     from-slate-300 via-slate-300 to-red-300  text-gray-400 p-0 sm:p-4 md:p-10 flex gap-4'
		>
			...
			<div
				className={`w-full sm:w-4/5 h-full shadow-2xl  bg-[url('assets/telegrambg.png')]  bg-fixed flex flex-col justify-between`}
			>
				<ChatHeader />
				...
				<div className='p-2  bg-slate-500 bg-opacity-70'>
					<form
						action=''
						className='p-0 m-0 flex w-full sm:w-3/4 rounded-full mx-auto'
					>
						<textarea
							name='content'
							id=''
							className='m-0 bg-gradient-to-r from-red-300 to-blue-300 w-full rounded-full px-4 py-1 outline-none text-white h-10'
						></textarea>
						<button className='bg-red-400 hover:bg-blue-600 duration-1000 text-white font-extrabold rounded-full w-20 flex justify-center items-center'>
							<AiOutlineSend className='font-extrabold text-2xl' />
						</button>
					</form>
				</div>
			</div>
